...
function hideUnwantedBasemapLabels(
    ...
    style.layers.forEach(
        layer => {
            ...
            // =================================================
            // REMOVE SPECIFIC PARK / RESERVATION LABELS
            // =================================================
            ...
            try {
                ...
                // Some Mapbox symbol layers cannot accept
                // this filter. Ignore those layers.
...
async function refreshCompareManifests() {
    ...
    // ========================================================
    // ONLY HOURS AVAILABLE IN BOTH MODELS
    // ========================================================
